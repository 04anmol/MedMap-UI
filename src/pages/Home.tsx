...
const Home = () => {
  ...
  return (
    <div className="px-4 pt-8 pb-4 min-h-screen bg-gradient-subtle">
        ...
        <div className="grid grid-cols-2 gap-4">
          {quickAccessCards.map((card) => (
            <div
              ...
              className="medmap-card hover:shadow-glow transition-all duration-300 hover:scale-105 cursor-pointer group overflow-hidden relative"
            >
              <div className="relative z-10">
                <div className={`w-14 h-14 ${card.gradient} rounded-2xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-200 shadow-lg`}>
      ...
      {/* Health Insights */}
      <section className="mb-8">
        <div className="medmap-card bg-gradient-wellness overflow-hidden relative">
          <div className="relative z-10">
            <div className="flex items-center justify-between mb-4">
              <div className="text-white">
      ...
      <section>
        ...
        <div className="space-y-4">
          <div className="medmap-card hover:shadow-lg transition-all duration-200">
            <div className="flex items-center gap-4">
          ...
          <div className="medmap-card hover:shadow-lg transition-all duration-200">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 bg-gradient-pink rounded-2xl flex items-center justify-center shadow-lg">
